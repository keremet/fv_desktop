...
#define FUNC_BLOCK_AGR_PROP(NAME)  typedef void(*callback_##NAME)(void* param, PARAMS_ID_##NAME, PARAMS_##NAME); \
...
public:
	...
	typedef void(*callback_fv_agr)(void* param, int id, PARAMS_fv_agr_select); 
	int select_fv_agr(PARAMS_FILTER_fv_agr, callback_fv_agr cb, void* param); 
	
	typedef void(*callback_select_fv_schedule_and_payment_states)(void* param, 
	...
	typedef void(*callback_fv_schedules)(void* param, int id, int start_date, int reason_id, financial oper_sum, const char* comment); 
